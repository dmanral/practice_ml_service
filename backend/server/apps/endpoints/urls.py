# The above code will create REST API routers to our database models. Our models
# will be accessed by following the URL pattern:
#
# http://<server-ip>/api/v1/<object-name>
# You can notice that we include v1 in the API address. This might be needed later
# for API versioning.
