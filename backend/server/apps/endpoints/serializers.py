...
# parent_mlalgorithm are in read and write mode, we will use the to set algorithm
# status by REST API. For MLRequest serializer there is a feedback field that is
# left in read and write mode - it will be needed to provide feedback about predictions
# to the server.
#
# The MLAlgorithmSerializer is more complex than others. It has one filed current_status
